    ...
    public class ProductController : Controller
    {
        ...
        private async Task<string?> SaveProductImageAsync(IFormFile file)
        {
            ...
            try
            {
                ...
                {
                    var shopDir = Path.Combine(solutionRoot, "SV22T1020555.Shop", "wwwroot", "images", "products");
        ...
        private async Task TryDeleteImageIfUnusedAsync(string fileName)
        {
            ...
            if (await CatalogDataService.IsPhotoUsedAsync(fileName))
                return;
        ...
        private static void DeleteImageInBothSites(string fileName)
        {
            ...
            var shopPath = Path.Combine(solutionRoot, "SV22T1020555.Shop", "wwwroot", "images", "products", fileName);
