...
namespace SV22T1020555.BusinessLayers
{
    ...
    public static class CatalogDataService
    {
        ...
        /// <returns>True nếu đang dùng; False nếu không còn dùng.</returns>
        public static async Task<bool> IsPhotoUsedAsync(string fileName)
        {
            if (string.IsNullOrWhiteSpace(fileName))
                return false;
            return await productDB.IsPhotoUsedAsync(fileName);
        }
