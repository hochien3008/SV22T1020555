...
namespace SV22T1020555.BusinessLayers
{
    ...
    {
        /// <summary>
        /// Giá trị họ tên giữ chỗ được gán khi khách đăng ký nhưng chưa cập nhật hồ sơ.
        /// </summary>
        public const string PendingCustomerDisplayName = "(Cập nhật sau đăng ký)";

        /// <summary>
        /// Kiểm tra xem tên khách hàng có đang là giá trị giữ chỗ (chưa cập nhật) hay không.
        /// </summary>
        /// <param name="customerName">Tên hiển thị cần kiểm tra.</param>
        /// <returns>
        /// True nếu tên là giữ chỗ hoặc rỗng, ngược lại False.
        /// </returns>
