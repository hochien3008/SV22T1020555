...
namespace SV22T1020555.BusinessLayers
{
    ...
    /// bao gồm: nhân viên (Employee), phân quyền và quản lý mật khẩu.
    /// </summary>
    public static class HRDataService
    {
        ...
        /// <summary>
        /// Lấy chuỗi vai trò (RoleNames) của nhân viên dưới dạng CSV (ví dụ: "admin,sales").
        /// </summary>
        /// <param name="employeeID">Mã nhân viên cần lấy vai trò.</param>
        /// <returns>
        /// Chuỗi CSV các vai trò nếu có; null hoặc rỗng nếu chưa được gán vai trò.
        /// </returns>
        ...
        /// <summary>
        /// Cập nhật chuỗi vai trò (RoleNames) của nhân viên dưới dạng CSV (ví dụ: "admin,sales").
        /// </summary>
        /// <param name="employeeID">Mã nhân viên cần cập nhật vai trò.</param>
        /// <param name="roleNames">Chuỗi CSV các vai trò mới cần gán.</param>
        /// <returns>
        /// True nếu cập nhật thành công, ngược lại False.
        /// </returns>
        ...
        /// <summary>
        /// Đổi mật khẩu của nhân viên (yêu cầu xác thực đúng mật khẩu cũ đã hash).
        /// </summary>
        ...
        /// <returns>
        /// True nếu đổi thành công (mật khẩu cũ khớp), ngược lại False.
        /// </returns>
        ...
        /// <summary>
        /// Thiết lập lại mật khẩu của nhân viên (không cần xác thực mật khẩu cũ, dùng cho admin reset).
        /// </summary>
        /// <param name="employeeID">Mã nhân viên cần thiết lập lại mật khẩu.</param>
        /// <param name="newPassword">Mật khẩu mới đã hash (MD5).</param>
        /// <returns>
        /// True nếu thiết lập thành công, ngược lại False.
        /// </returns>
